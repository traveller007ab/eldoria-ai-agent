...
import { Settings, Zap, Thermometer, Droplets, Power, Settings as SettingsIcon, ChevronDown, ChevronRight, Info, AlertTriangle, CheckCircle } from 'lucide-react';
...
export const ComponentOptimizerPanel: React.FC = () => {
    const { currentBlueprint: blueprint, setBlueprint } = useMechStore();
            ...
            {isExpanded && (
                <div className="p-4 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {PRESETS.map(preset => (
                                <button
                                    ...
                                    className={`p-2 rounded border text-left transition-colors ${selectedPreset === preset.id
                    ...
                    <button
                        ...
                        className={`w-full py-2 rounded font-medium text-sm transition-all ${isOptimizing || customTargets.length === 0
